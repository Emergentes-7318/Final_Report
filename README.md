...
| 3ra    |  16/11/2025 | Cabanillas Gora Andrea Milagros, Olivera Guerra, Santiago Mickelle , Vasquez Requejo Augusto Mathias Leonardo, Navarro Lorenzo, Alonso Diego |Mejora continua y Capitulos VI y VII.|
| 4ta    |  16/11/2025 | Cabanillas Gora Andrea Milagros, Olivera Guerra, Santiago Mickelle , Vasquez Requejo Augusto Mathias Leonardo, Navarro Lorenzo, Alonso Diego |Mejora continua|
...
https://github.com/Emergentes-7318/Final_Report
...
| ---------------------------------------- | ----------------------- |
| Alonso Garay, Diego Jesus         | Capitulo IV |
| Cabanillas Gora Andrea            | Capitulo II |
| Navarro Robles, Lorenzo Sebastian | Capitulo III |
| Olivera Guerra, Santiago Mickelle | Capitulo IV |
| Vasquez Requejo, Augusto Mathias  | Capitulo I, II, III, IV |
...
| Integrante                               | Tareas Asignadas        |
| ---------------------------------------- | ----------------------- |
| Alonso Garay, Diego Jesus         | Desarrollo Web Application |
| Cabanillas Gora Andrea            | Desarrollo Web Application |
| Navarro Robles, Lorenzo Sebastian | Desarrollo Web Application |
| Olivera Guerra, Santiago Mickelle | Desarrollo Web Application |
| Vasquez Requejo, Augusto Mathias  | Desarrollo Web Application y Landing page|
...
| Navarro Robles, Lorenzo Sebastian | Desarrollo Web Application |
| Olivera Guerra, Santiago Mickelle | Desarrollo Web Application |
| Vasquez Requejo, Augusto Mathias  | Desarrollo Web Application |
...
- [Capítulo I: Introducción](/docs/Chapter-01.md)
  ...
  - [1.2. Solution Profile](/docs/Chapter-01.md#12-solution-profile)
    ...
    - [1.2.2. Lean UX Process](/docs/Chapter-01.md#122-lean-ux-process)
      ...
      - [1.2.2.3. Lean UX Hypothesis Statements](/docs/Chapter-01.md#1223-lean-ux-hyphotesis-statements)
...
- [Capítulo II: Requirements Elicitation & Analysis](/docs/Chapter-02.md)
  ...
  - [2.3. Needfinding](/docs/Chapter-02.md#23-needfinding)
    ...
    - [2.3.3. Empathy Mapping](/docs/Chapter-02.md#233-empathy-mapping)
    - [2.3.4. As-is Scenario Mapping](/docs/Chapter-02.md#234-as-is-scenario-mapping)
    - [2.3.5. Ubiquitous Language](/docs/Chapter-02.md#235-ubiquitous-language)

- [Capítulo III: Requirements Specification](/docs/Chapter-03.md)
  - [3.1. To-Be Scenario Mapping](/docs/Chapter-03.md#31-to-be-scenario-mapping)
  - [3.2. User Stories](/docs/Chapter-03.md#32-user-stories)
  - [3.3. Impact Mapping](/docs/Chapter-03.md#33-impact-mapping)
  - [3.4. Product Backlog](/docs/Chapter-03.md#34-product-backlog)

- [Capítulo IV: Solution Software Design](/docs/Chapter-04.md)
  - [4.1. Strategic-Level Attribute-Driven Design](/docs/Chapter-04.md#41-strategic-level-attribute-driven-design)
    - [4.1.1. Design Purpose](/docs/Chapter-04.md#411-design-purpose)
    - [4.1.2. Attribute-Driven Design Inputs](/docs/Chapter-04.md#412-attribute-driven-design-inputs)
      - [4.1.2.1. Primary Functionality (Primary User Stories)](/docs/Chapter-04.md#4121-primary-functionality-primary-user-stories)
      - [4.1.2.2. Quality Attribute Scenarios](/docs/Chapter-04.md#4122-quality-attribute-scenarios)
      - [4.1.2.3. Constraints](/docs/Chapter-04.md#4123-constraints)
    - [4.1.3. Architectural Drivers Backlog](/docs/Chapter-04.md#413-architectural-drivers-backlog)
    - [4.1.4. Architectural Design Decisions](/docs/Chapter-04.md#414-architectural-design-decisions)
    - [4.1.5. Quality Attribute Scenario Refinements](/docs/Chapter-04.md#415-quality-attribute-scenario-refinements)
  - [4.2. Strategic-Level Domain-Driven Design](/docs/Chapter-04.md#42-strategic-level-domain-driven-design)
    - [4.2.1. EventStorming](/docs/Chapter-04.md#421-eventstorming)
    - [4.2.2. Candidate Context Discovery](/docs/Chapter-04.md#422-candidate-context-discovery)
    - [4.2.3. Domain Message Flows Modeling](/docs/Chapter-04.md#423-domain-message-flows-modeling)
    - [4.2.4. Bounded Context Canvases](/docs/Chapter-04.md#424-bounded-context-canvases)
    - [4.2.5. Context Mapping](/docs/Chapter-04.md#425-context-mapping)
  - [4.3. Software Architecture](/docs/Chapter-04.md#43-software-architecture)
    - [4.3.1. System Landscape Diagram](/docs/Chapter-04.md#431-software-architecture-system-landscape-diagram)
    - [4.3.2. Context Level Diagrams](/docs/Chapter-04.md#432-software-architecture-context-level-diagrams)
    - [4.3.3. Container Level Diagrams](/docs/Chapter-04.md#433-software-architecture-container-level-diagrams)
    - [4.3.4. Deployment Diagrams](/docs/Chapter-04.md#434-software-architecture-deployment-diagrams)

- [Capítulo V: Tactical-Level Software Design](/docs/Chapter-05.md)
  - [5.1. Bounded Context: Document Management](/docs/Chapter-05.md#51-bounded-context-document-management)
    - [5.1.1. Domain Layer](/docs/Chapter-05.md#511-domain-layer)
    - [5.1.2. Interface Layer](/docs/Chapter-05.md#512-interface-layer)
    - [5.1.3. Application Layer](/docs/Chapter-05.md#513-application-layer)
    - [5.1.4. Infrastructure Layer](/docs/Chapter-05.md#514-infrastructure-layer)
    - [5.1.6. Component Level Diagrams](/docs/Chapter-05.md#516-bounded-context-software-architecture-component-level-diagrams)
    - [5.1.7. Code Level Diagrams](/docs/Chapter-05.md#517-bounded-context-software-architecture-code-level-diagrams)
  - [5.2. Bounded Context: Chat Service](/docs/Chapter-05.md#52-bounded-context-chat-service)
    - [5.2.1. Domain Layer](/docs/Chapter-05.md#521-domain-layer)
    - [5.2.2. Interface Layer](/docs/Chapter-05.md#522-interface-layer)
    - [5.2.3. Application Layer](/docs/Chapter-05.md#523-application-layer)
    - [5.2.4. Infrastructure Layer](/docs/Chapter-05.md#524-infrastructure-layer)
    - [5.2.6. Component Level Diagrams](/docs/Chapter-05.md#526-bounded-context-software-architecture-component-level-diagrams)
    - [5.2.7. Code Level Diagrams](/docs/Chapter-05.md#527-bounded-context-software-architecture-code-level-diagrams)

- [Capítulo VI: Product Design](/docs/Chapter-06.md)
  - [6.1. Style Guidelines](/docs/Chapter-06.md#61-style-guidelines)
    - [6.1.1. General Style Guidelines](/docs/Chapter-06.md#611-general-style-guidelines)
    - [6.1.2. Web, Mobile & Devices Style Guidelines](/docs/Chapter-06.md#612-web-mobile--devices-style-guidelines)
      - [6.1.2.1. iOS Mobile Style Guidelines](/docs/Chapter-06.md#6121-ios-mobile-style-guidelines)
      - [6.1.2.2. Android Mobile Style Guidelines](/docs/Chapter-06.md#6122-android-mobile-style-guidelines)
  - [6.2. Information Architecture](/docs/Chapter-06.md#62-information-architecture)
    - [6.2.2. Labeling Systems](/docs/Chapter-06.md#622-labeling-systems)
    - [6.2.3. Searching Systems](/docs/Chapter-06.md#623-searching-systems)
    - [6.2.4. SEO Tags and Meta Tags](/docs/Chapter-06.md#624-seo-tags-and-meta-tags)
    - [6.2.5. Navigation Systems](/docs/Chapter-06.md#625-navigation-systems)
  - [6.3. Landing Page UI Design](/docs/Chapter-06.md#63-landing-page-ui-design)
    - [6.3.1. Landing Page Wireframe](/docs/Chapter-06.md#631-landing-page-wireframe)
    - [6.3.2. Landing Page Mock-up](/docs/Chapter-06.md#632-landing-page-mock-up)
  - [6.6. Applications UX/UI Design](/docs/Chapter-06.md#66-applications-uxui-design)
    - [6.6.1. Applications Wireframes](/docs/Chapter-06.md#661-applications-wireframes)
    - [6.6.2. Applications Wireflow Diagrams](/docs/Chapter-06.md#662-applications-wireflow-diagrams)
    - [6.6.3. Applications Mock-ups](/docs/Chapter-06.md#663-applications-mock-ups)
    - [6.6.4. Applications User Flow Diagrams](/docs/Chapter-06.md#664-applications-user-flow-diagrams)
  - [6.5. Applications Prototyping](/docs/Chapter-06.md#65-applications-prototyping)

- [Conclusiones](/docs/Conclusions.md)
- [Bibliografía](/docs/Bibliography.md)
- [Anexos](/docs/Appendix.md)


# Student Outcome

| Criterio específico                                           | Integrante                                   | Acciones realizadas vinculadas al criterio                                                                                 |
|---------------------------------------------------------------|----------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|
| Capacidad de comunicarse efectivamente con un rango de audiencias | Augusto Mathias Leonardo Vasquez Requejo     | TB1: Chapter 01 y aportes en los demás capítulos. TP1: Mejora continua del informe y desarrollo de los capítulos 5 y 6. TB2: Mejora continua del informe y desarrollo de los capítulos 6 y 7. TF: Mejora continua del informe y desarrollo del TF. |
|                                                               | Andrea Cabanillas Gora                       | TB1: Chapter 02 y aportes en los demás capítulos. TP1: Mejora continua del informe y desarrollo de los capítulos 5 y 6. TB2: Mejora continua del informe y desarrollo de los capítulos 6 y 7. TF: Mejora continua del informe y desarrollo del TF. |
|                                                               | Santiago Mickelle Olivera Guerra             | TB1: Chapter 03 y aportes en los demás capítulos. TP1: Mejora continua del informe y desarrollo de los capítulos 5 y 6. TB2: Mejora continua del informe y desarrollo de los capítulos 6 y 7. TF: Mejora continua del informe y desarrollo del TF. |
|                                                               | Diego Jesús Alonso Garay                     | TB1: Chapter 04 y aportes en los demás capítulos. TP1: Mejora continua del informe y desarrollo de los capítulos 5 y 6. TB2: Mejora continua del informe y desarrollo de los capítulos 6 y 7. TF: Mejora continua del informe y desarrollo del TF. |
|                                                               | Navarro Robles, Lorenzo Sebastián            | TB1: Chapter 04 y aportes en los demás capítulos. TP1: Mejora continua del informe y desarrollo de los capítulos 5 y 6. TB2: Mejora continua del informe y desarrollo de los capítulos 6 y 7. TF: Mejora continua del informe y desarrollo del TF. |

**Conclusión** para el criterio **“Capacidad de comunicarse efectivamente con un rango de audiencias”**

El desarrollo de DocMind potencia la capacidad del equipo para comunicarse efectivamente con un rango de audiencias, ya que al definir épicas, user stories y criterios de aceptación deben expresar de manera clara y precisa requerimientos técnicos comprensibles tanto para programadores como para docentes, clientes potenciales o usuarios finales. Además, al preparar el backlog y priorizar funcionalidades, aprenden a adaptar el lenguaje según la audiencia, utilizando términos ágiles y métricas de negocio para gerentes, explicaciones técnicas para desarrolladores y mensajes sencillos para usuarios. En la documentación, presentaciones y reportes del proyecto, el equipo practica cómo traducir ideas complejas de inteligencia artificial, seguridad y arquitectura cloud en explicaciones accesibles, lo que fortalece su competencia para interactuar en contextos académicos, profesionales y empresariales diversos.
...
|--------------------------|--------------------------|-----------------------------|
| Profesionales de distintos sectores (académico, legal, empresarial) enfrentan un volumen creciente de documentos complejos en PDF que requieren horas de lectura y análisis, lo que genera retrasos, errores de interpretación y pérdida de productividad.<br><br>**¿Cómo podríamos automatizar el análisis de documentos y la generación de reportes inteligentes en tiempo real para cerrar esta brecha de eficiencia y acceso a la información?** | Aplicación web y móvil que permita:<br>- Cargar documentos PDF o importar desde Google Drive.<br>- Generar resúmenes automáticos y responder preguntas en lenguaje natural.<br>- Visualizar respuestas con citas enlazadas al texto fuente.<br>- Exportar reportes ejecutivos y técnicos en formatos estándar (PDF/Word/Markdown).<br>- Acceder a paneles de métricas de uso y calidad. | - Lograr una adopción inicial del 40% en universidades y despachos legales durante los primeros 6 meses.<br>- Alcanzar que el 60% de los usuarios activos realicen ≥ 2 sesiones por semana.<br>- Generar al menos 3 clientes corporativos (empresas/consultoras) en el primer año. |

| **Usuarios y Clientes** | **Beneficios del Usuario** |
|--------------------------|-----------------------------|
| - Investigadores y estudiantes universitarios.<br>- Abogados y consultores.<br>- Gerentes y profesionales de empresas que necesitan extraer datos clave de informes.<br>- Hermanos o familiares que participan en proyectos académicos y legales colaborativos. | - **Ahorro de tiempo:** reducción del 50% en lectura y análisis.<br>- **Mayor precisión:** disminución de errores gracias a respuestas con citas verificables.<br>- **Confianza y seguridad:** control de acceso y trazabilidad.<br>- **Productividad transversal:** aplicable a educación, derecho y negocios. |

| **Hipótesis** | **Lo más Importante que Necesitamos Aprender Primero** | **La Menor Cantidad de Trabajo para Aprenderlo** |
|---------------|---------------------------------------------------------|--------------------------------------------------|
| Creemos que, al implementar resúmenes automáticos y preguntas-respuestas con citas, aumentaremos el interés y confianza de los usuarios en adoptar DocMind.<br><br>Sabremos que hemos tenido éxito cuando al menos el 60% de los usuarios generen 3 resúmenes semanales y el 70% consulten citas dentro del visor. | - ¿Qué tan precisa y confiable es la IA para resumir y responder preguntas sobre documentos técnicos y legales?<br>- ¿Qué formato de reporte (ejecutivo, técnico, académico) es más valorado por los distintos segmentos de usuarios? | - Prototipo funcional de carga de documentos y resumen básico con un LLM.<br>- Prueba piloto con 5 usuarios académicos y 5 legales.<br>- Métrica: lograr ≥ 80% de satisfacción en claridad de resúmenes y ≥ 85% de precisión percibida en respuestas con citas. |
...
|-----------|------------|------------|-------------------|
| Mejorar la eficiencia y precisión en la gestión documental mediante una plataforma impulsada por **IA**, que automatice la clasificación, búsqueda y análisis de documentos, reduciendo tiempos operativos y errores humanos. | **Usuarios finales (empleados):**<br>Requieren una manera rápida y confiable de encontrar y gestionar documentos sin perder tiempo en búsquedas manuales.<br><br>**Gerentes y supervisores:**<br>Necesitan reportes precisos sobre la documentación procesada para tomar decisiones estratégicas y asegurar cumplimiento normativo.<br><br>**Equipo de TI:**<br>Busca una solución escalable, segura e integrable con sistemas existentes (ERP, CRM, etc.). | **Incremento de la productividad:**<br>Reduce significativamente el tiempo invertido en búsqueda y gestión manual de documentos.<br><br>**Mejora en la precisión y reducción de errores:**<br>Clasificación automática y análisis inteligente, minimizando inconsistencias.<br><br>**Cumplimiento normativo y trazabilidad:**<br>Garantiza que los documentos estén organizados y accesibles para auditorías y revisiones.<br><br>**Decisiones basadas en datos:**<br>Los reportes y analíticas de la plataforma brindan información clave para optimizar procesos y flujos de trabajo. | **Plataforma DocMind con IA integrada:**<br>Solución web con motor de inteligencia artificial para clasificación y análisis automático de documentos.<br><br>**Sistema de búsqueda inteligente:**<br>Permite encontrar documentos por contexto, etiquetas y contenido semántico.<br><br>**Dashboard de reportes y métricas:**<br>Visualización en tiempo real del estado documental y cumplimiento normativo.<br><br>**Integraciones seguras:**<br>Conexiones con sistemas ERP, CRM y almacenamiento en la nube.<br><br>**Documentación técnica y manuales de usuario:**<br>Guías detalladas para implementación y uso efectivo de la plataforma. |
...
| Sprint 1 Goal                      | Nuestro enfoque está en entregar la presencia web inicial y la interfaz de análisis para la plataforma DocMind, incluyendo una landing page responsiva y un módulo web funcional, de modo que los médicos y profesionales del derecho en salud puedan comprender rápidamente la propuesta de valor, cargar documentos de prueba y visualizar un resumen médico-legal inicial asistido por IA. |
...
| **Sprint Goal & User Stories**     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Sprint 2 Goal                      | Nuestro enfoque es habilitar una experiencia completa de análisis documental de extremo a extremo: los usuarios que lleguen desde la página de inicio podrán iniciar sesión, importar documentos desde Google Drive, realizar preguntas en lenguaje natural sobre sus archivos PDF y visualizar respuestas generadas por la IA con citas básicas dentro del visor web.                                                                                                                                                                                                                                                                                                                                                                      |
...
Enlace al video de About the product: https://youtu.be/RTo2_SW8ntw 
